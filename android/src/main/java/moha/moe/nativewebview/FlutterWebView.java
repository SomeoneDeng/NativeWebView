...
//            webView.loadUrl(url);
        ...
        methodChannel = new MethodChannel(messenger, "moha.moe/webview_" + id);
    ...
    private void loadHtmlString(MethodCall methodCall, Result result) {
        Log.i(TAG, "loading...");
        webView.loadData((Objects.requireNonNull(methodCall.argument("html")).toString()), "text/html", "utf-8");
        result.success(null);
    }
